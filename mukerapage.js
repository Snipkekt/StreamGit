...
const trending = allMovie.filter(m =>
  m.categories.includes("trending")
);
...
animation.forEach(Ani => {
    ...
    AniDiv.appendChild(img);
    AniDiv.appendChild(title);

    container.appendChild(AniDiv);
});